<div<?php print $attributes; ?>>
  <div<?php print $content_attributes; ?>>
    ...
    <div class="branding-data clearfix">
      ...
      <div class="logo-img">
				<?php global $language_content;?>
				<?php print l(theme_image(array('path'=>drupal_get_path('theme','mayatime')."/img/logo-".$language_content->language.".png",'alt'=>$site_name." - ".$site_slogan,'attributes'=>array())),'<front>',array('html'=>true));?>
